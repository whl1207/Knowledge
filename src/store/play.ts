const axios = null as any //修复require("axios");
//const { v4: uuidv4 } = null as any //修复require("uuid");
const ws = null as any //修复require("nodejs-websocket");
...
async function getTTSData(
  ...
  const XConnectionId = null //修复uuidv4().toUpperCase().replaceAll("-", "");
